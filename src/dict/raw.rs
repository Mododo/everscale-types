...
mod tests {
        ...
        fn consume_gas(&mut self, cell: &DynCell, mode: LoadMode) {
            ...
            if mode.use_gas() {
                self.used_gas += if self.loaded_cells.insert(*cell.repr_hash()) {
                    println!("LOAD NEW {hash_str}");
                    Self::NEW_CELL_GAS
                } else {
                    println!("LOAD OLD {hash_str}");
                    Self::OLD_CELL_GAS
                };
            } else {
                println!("LOAD free {hash_str} {mode:?}");
            }
        }
    }
    ...
    #[test]
    fn test_dict_find_owned() {
        fn find(dict: &'static str, key: &'static str) -> (u64, Option<HashBytes>) {
            let dict = Boc::decode_base64(dict).unwrap();
            let key = Boc::decode_base64(key).unwrap();
            let key = key.as_slice().unwrap();
            let context = &mut SimpleContext::default();
            let found_cell = dict_find_owned(
                Some(&dict),
                key.size_bits(),
                key,
                DictBound::Max,
            ...
            .unwrap()
            .map(|(_k, v)| *v.0.repr_hash());
            (context.used_gas, found_cell)
        }

        println!("a");
        let a = find(
            "",
            "te6ccgEBAQEAIgAAQAT/XAb3IDV+3Qn9uUl5uZmBmpCzhF8tULloDUk1L2sg",
        );
        println!("b");
        let b = find(
            "",
            "te6ccgEBAQEAIgAAQAYeN93oVWGU5hSJFDByH3+rm7qFj1EjQn2i40Grf3fh",
        );
        println!("c");
        let c = find(
            "",
            "te6ccgEBAQEAIgAAQEhxZM682zLrPdY8FGi6y3ipQuipi8GbfytOvpYQfHKR",
        );
        println!("d");
        let d = find(
            "te6ccgEBAwEAWwACAnACAQBRvwUs9Y7wA5Rzk9FAuVEaJDbNoojqU1tq7iEKATDgOk2gAAAAAZR21/4AUb86R5jAJktNvWShPxj/CYLobHEvpWNwvjq1IkR1h+RX4AAAAAP////+",
            "te6ccgEBAQEAIgAAQA6R5jAJktNvWShPxj/CYLobHEvpWNwvjq1IkR1h+RX4",
        );
        println!("e");
        let e = find(
            "te6ccgEBAwEAWwACAnACAQBRvwUs9Y7wA5Rzk9FAuVEaJDbNoojqU1tq7iEKATDgOk2gAAAAAZR21/4AUb86R5jAJktNvWShPxj/CYLobHEvpWNwvjq1IkR1h+RX4AAAAAP////+",
            "te6ccgEBAQEAIgAAQBFLPWO8AOUc5PRQLlRGiQ2zaKI6lNbau4hCgEw4DpNo",
        );
        println!("f");
        let f = find(
            "",
            "te6ccgEBAQEAIgAAQEa1vrVvkLPyrvqDqgxlLlo6FEnbasDfqdcCDPQUwtcR",
        );

        let results = [
            (
                725,
                Some("94618baea048d0adc0c5140bab696d99029f0cab81a9b6897ff62f74e1f19a0e"),
            ),
            (
                625,
                Some("0dc4002ed831d59946d569ecee469b6301505309c3a002b6d6f65d02a1a2c297"),
            ),
            (
                700,
                Some("8551208eade30bc3593b6abbb96bd6980b0e4e78c6da95aacf3f341c235ff365"),
            ),
            (
                300,
                Some("eb96de0211e0772dfc269760982c922c947de0c905daf7a3bb8f7fa8d45bb3a9"),
            ),
            (200, None),
            (
                725,
                Some("dd7d3f0954f0f6db67f984abe9c574e86b420e32a3341219a7eff916ea49e567"),
            ),
        ]
        .into_iter()
        .map(|(g, h)| (g, h.map(|h| (HashBytes::from_str(h).unwrap()))))
        .collect::<Vec<_>>();

        assert_eq!(results, [a, b, c, d, e, f]);
    }
}
